...
<div class="steps" id="step-nav"><span class="is-active" data-step="1" aria-current="step">1. [[i18n:workerSetup.environmentOverview]]</span><span data-step="2">2. [[i18n:workerSetup.configureNode]]</span><span data-step="3">3. [[i18n:workerSetup.generateScript]]</span><span data-step="4">4. [[i18n:workerSetup.startNode]]</span></div>

<div class="panel step-panel active" id="step-1">
...
<div class="panel step-panel" id="step-2">
...
<div class="panel step-panel" id="step-3">
...
<div class="panel step-panel" id="step-4">
...
function goStep(n){for(var i=1;i<=4;i++){document.getElementById('step-'+i).className='panel step-panel'+(i===n?' active':'');document.querySelectorAll('.steps span')[i-1].className=(i===n?'is-active':'')}}
