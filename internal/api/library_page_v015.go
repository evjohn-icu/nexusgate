...
var libraryPagePatches = []pagePatch{
	...
	{anchor: `.library{display:grid;gap:13px}`,
		replacement: `html,body{overflow-x:clip}.filters,.semantic-filters{display:grid;grid-template-columns:repeat(6,minmax(0,1fr)) auto;gap:9px;margin:0 0 12px;padding:13px;background:var(--ui-surface);border:1px solid var(--ui-border);border-radius:14px}.semantic-filters{grid-template-columns:repeat(8,minmax(110px,1fr))}.filters label,.semantic-filters label{display:block;color:#93a6c6;font-size:10px;font-weight:800;letter-spacing:.06em;margin-bottom:5px}.filters input,.filters select,.semantic-filters input,.semantic-filters select{width:100%;padding:8px 9px}.filters button{align-self:end}.filters .collections-hint{margin:6px 0 0;font-size:11px;line-height:1.5}.filters .collections-hint.warn{color:#ffc0ca}.processing-summary{display:flex;gap:7px;flex-wrap:wrap;margin:0 0 18px}.status-pill{border:1px solid #385072;border-radius:999px;padding:5px 9px;color:#bed0ed;font-size:12px}.status-pill b{color:#fff}.group-title{margin:20px 2px 8px;color:#cbd8f0;font-size:13px;font-weight:850;letter-spacing:.02em}.search-bar{margin:0 0 12px}.search-bar input{width:100%;padding:11px 13px;border:1px solid var(--ui-border-strong);border-radius:12px;background:#111d30;color:#fff;font:inherit}.advanced-filters{margin:0 0 12px;border:1px solid var(--ui-border);border-radius:14px;background:var(--ui-surface)}.advanced-filters summary{cursor:pointer;padding:11px 13px;color:#b7c8eb;font-weight:800;font-size:13px;user-select:none}.advanced-filters .advanced-grid{grid-template-columns:repeat(8,minmax(0,1fr));gap:9px;padding:0 13px 13px}.advanced-filters:not([open]) .advanced-grid{display:none}.advanced-filters[open] .advanced-grid{display:grid}.advanced-filters label{display:block;color:#93a6c6;font-size:10px;font-weight:800;letter-spacing:.06em;margin-bottom:5px}.advanced-filters input,.advanced-filters select{width:100%;padding:8px 9px}.shot-results-head{display:flex;align-items:center;justify-content:space-between;gap:14px;margin:0 0 14px}.link-button{background:none;border:0;color:#93aaff;font-weight:800;cursor:pointer;padding:0}.shot-result{display:grid;grid-template-columns:200px 1fr;gap:14px;align-items:start;padding:13px;background:var(--ui-surface);border:1px solid var(--ui-border);border-radius:16px;cursor:pointer;margin:0 0 11px;transition:border-color .15s}.shot-result:hover{border-color:var(--ui-border-strong)}.shot-result .thumb{width:100%;aspect-ratio:16/9;object-fit:cover;border-radius:10px;background:#070d17;min-height:0}.shot-result-head{display:flex;align-items:baseline;gap:10px;flex-wrap:wrap}.shot-result-file{color:#fff;font-size:14px}.shot-result-time{color:#b7c8eb;font-size:13px;font-weight:700}.shot-result-desc{margin:8px 0;color:#d6e1f7;line-height:1.55}.shot-evidence{margin:6px 0 8px;padding:8px 10px;background:#0c1526;border:1px solid #26395a;border-radius:10px;color:#b7c8eb;font-size:12px;line-height:1.7}.shot-evidence .ev-confirmed{color:#6fe3a1}.shot-evidence .ev-possible{color:#f0c674}.shot-evidence .ev-contradicted{color:#ff7b72}.shot-evidence .ev-unknown{color:#8fa3c4}.shot-drawer{position:fixed;inset:0;z-index:40;display:none;pointer-events:none}.shot-drawer.open{display:block;pointer-events:auto}.shot-drawer-backdrop{position:absolute;inset:0;background:#04070dee}.shot-drawer-panel{position:absolute;top:0;right:0;bottom:0;width:min(520px,94vw);background:#101b2e;border-left:1px solid var(--ui-border);display:flex;flex-direction:column}.shot-drawer.open .shot-drawer-panel{animation:shotDrawerIn .18s ease}@keyframes shotDrawerIn{from{transform:translateX(100%)}to{transform:translateX(0)}}.shot-drawer-head{display:flex;justify-content:flex-end;padding:12px 14px;border-bottom:1px solid var(--ui-border)}.shot-drawer-close{background:var(--ui-border);color:#fff;border:0;border-radius:9px;width:34px;height:34px;font-size:17px;cursor:pointer}.shot-drawer-body{overflow:auto;padding:16px}.shot-drawer-body video{width:100%;border-radius:12px;background:#070d17}.shot-drawer-title{font-size:16px;font-weight:850;color:#fff;margin:14px 0 4px}.shot-drawer-time{color:#93aaff;font-weight:800;font-size:13px}.shot-drawer-desc{color:#d6e1f7;line-height:1.6;margin:10px 0}.shot-drawer-fields{margin-top:10px;display:grid;gap:4px;color:#9fb0ce;font-size:12px}.root-health{display:grid;gap:8px;margin:0 0 18px}.root-health-warn{display:flex;align-items:center;gap:9px;padding:10px 13px;background:#3a2230;border:1px solid #6e3a4a;border-radius:12px;color:#ffc0c8;font-size:13px;font-weight:700}.library{display:grid;gap:13px}`},
