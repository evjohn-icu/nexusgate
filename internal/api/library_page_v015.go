...
func filterDrawerHTML() string {
	...
	b.WriteString(`<div><label for="min-duration">[[i18n:library.filter.minDuration]]</label><input id="min-duration" type="number" min="0" step="any" inputmode="numeric" placeholder="[[i18n:library.filter.unlimited]]" onchange="load()"></div><div><label for="max-duration">[[i18n:library.filter.maxDuration]]</label><input id="max-duration" type="number" min="0" step="any" inputmode="numeric" placeholder="[[i18n:library.filter.unlimited]]" onchange="load()"></div></div>`)
	...
	b.WriteString(`<div><label for="camera-filter">[[i18n:library.filter.camera]]</label><input id="camera-filter" placeholder="[[i18n:library.filter.cameraPlaceholder]]" onchange="load()"></div><div><label for="region-filter">[[i18n:library.filter.region]]</label><input id="region-filter" placeholder="[[i18n:library.filter.regionPlaceholder]]" onchange="load()"></div><div><label for="session-filter">[[i18n:library.filter.session]]</label><select id="session-filter" onchange="load()"><option value="">[[i18n:library.filter.sessionEmpty]]</option></select></div></div>`)
