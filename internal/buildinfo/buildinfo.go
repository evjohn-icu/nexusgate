...
// nexusgate executables. It is a leaf package with no dependencies so both the
...
//
//	-ldflags "-X github.com/evjohn-icu/nexusgate/internal/buildinfo.Version=vX.Y.Z-alpha"
//
