...
func TestReanalysisProducesNewCanonicalRunKeepsOldAuditable(t *testing.T) {
	...
	pipeline := NewPipeline(repo, t.TempDir(), nil, nil, first, nil, media.HardwarePlan{}, nil, providerRouteDeferral)
	...
	pipeline = NewPipeline(repo, t.TempDir(), nil, nil, second, nil, media.HardwarePlan{}, nil, providerRouteDeferral)
