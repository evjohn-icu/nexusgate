...
templates reference (`timingdex:v0.30.0-alpha`) has to exist somewhere Unraid's
...
docker build --target gpu -t timingdex:v0.30.0-alpha .
```
...
upgrade: rebuild or repull the `timingdex:v0.30.0-alpha` tag, then recreate both
