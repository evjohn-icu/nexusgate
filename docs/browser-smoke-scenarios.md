...
go build -tags playwrightfixture -o /tmp/timingdex-playwright-fixture \
  ./cmd/timingdex-playwright-fixture
TIMINGDEX_PLAYWRIGHT_ADDR=127.0.0.1:4173 \
  /tmp/timingdex-playwright-fixture
```
